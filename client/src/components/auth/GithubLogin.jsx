 ...
 * @param {boolean} props.showIcon - Whether to show the GitHub icon
 */
const GithubLogin = ({ className = '', buttonText = 'Login with GitHub', showIcon = true }) => {
  ...
  useEffect(() => {
    ...
    if (location.pathname === '/auth/success') {
      loadUser()
        ...
        .catch(error => {
          console.error('Failed to load user after OAuth callback:', error);
